...
const PublicPropertiesPage = () => {
  ...
  // Fetch properties directly from public API
  useEffect(() => {
    const fetchPublicProperties = async () => {
      try {
        ...
        // Fetch only approved properties from public API
        const data = await propertiesApi.getAll();
        console.log('Public properties loaded:', data);
  ...
  useEffect(() => {
    console.log('Filtering properties:', { properties: properties.length, location, guests });
        ...
        <div className="container-custom relative z-10">
          ...
          <div className="mb-10 animate-fade-in">
            ...
            <p className="text-gray-600">
              {filteredProperties.length} approved properties found
          ...
          {filteredProperties.length > 0 ? (
            ...
            <div className="text-center py-16 bg-white rounded-lg shadow-sm animate-fade-in">
              ...
              <h2 className="text-2xl font-serif font-medium mb-3">No approved properties found</h2>
